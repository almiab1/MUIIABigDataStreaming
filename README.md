...
3) **Clustering utilizando KMeans**: Se aplica el clustering utilizando el modelo de KMeans y el umbral correspondiente. Esto se realiza llamando a la función ***clusteringPipeline*** con el DStream de facturas, el modelo de KMeans y el umbral transmitido. El resultado del clustering se publica en el tópico de Kafka "*anomalies\_kmeans*".
